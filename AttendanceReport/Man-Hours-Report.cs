...
namespace AttendanceReport
{
    public partial class Man_Hours_Report : Form
    {
        ...
        public Man_Hours_Report()
        {
            ...
            dtpFromDate.Value = Convert.ToDateTime("06/1/2022");
            dtpToDate.Value = Convert.ToDateTime("06/10/2022");
        }
        ...
        //    {
        //        if (cbxDepartments.Text.ToString() == "EFERTDHKALL")
        //        {
        //            MessageBox.Show("Please Select a Specific Department.");
        //        }
        //        else
        //        {
        //            await Task.Run(() =>
        ...
        //        if (cbxDepartments.Text.ToString() != "EFERTDHKALL")
        //        {
        //            MessageBox.Show("Please Select a EFERTDHKALL for this report.");
        //        }
        //        else
        //        {
        //            await Task.Run(() =>
        ...
        {
            string sss = checkedComboBox1.Text;
        ...
        public void Generate_ManHours_Summary_report()
        {
            try
            {
                ...
                filterByDepartment = this.cbxDepartments.Text.ToLower();
                filterBySection = this.cbxSections.Text.ToLower();
                filerByName = this.tbxName.Text.ToLower();
                filterByCadre = this.cbxCadre.Text.ToLower();
                filterByCompany = this.cbxCompany.Text.ToLower();
                filterByCNIC = this.tbxCnic.Text;
                filterByPnumber = this.tbxPNumber.Text;
            ...
            Back:
                ...
                if (cnicDateWiseReportInfo != null && cnicDateWiseReportInfo.Keys.Count > 0)
                {
                    ...
                    foreach (KeyValuePair<string, CardHolderReportInfo> reportInfo in cnicDateWiseReportInfo)
                    {
                        ...
                        if (reportType.Text.ToString() == "Man-Hours Detail Report")
                        {
                            #region Making Hours for Details report
                        ...
                        {
                            #region Making Hours for Summary Report
        ...
        private void saveFileDialog2_FileOk(object sender, CancelEventArgs e)
        {
            ...
            if (extension == ".pdf")
            {
                ...
                //  this.SaveAsPdf1(this.Summary_Report, "Man-Hour Summary Report");
                this.SaveAsPdf1(this.Summary_Report, "Man-Hour Summary Report", saveFileDialog2);
            }
            else if (extension == ".xlsx")
            {
                ...
                if (data != null)
                {
                    ...
                    using (ExcelPackage ex = new ExcelPackage())
                    {
                        ...
                        foreach (var Depart in data)
                        {
                            ...
                            if (cbxDepartments.Text.ToUpper() == Department)
                            {


                                foreach (var Date_CadreNics in Depart.Value)
                                {
                                    row++;
                    ...
                    using (PdfWriter pdfWriter = new PdfWriter(this.saveFileDialog1.FileName))
                    {
                        using (PdfDocument pdfDocument = new PdfDocument(pdfWriter))
                        {
                            using (Document doc = new Document(pdfDocument))
                            {
                                ...
                                this.AddNewEmptyRow1(table);

                                this.AddCategoryRow(table, "From Date :", dtpFromDate.Value.ToShortDateString());

                                this.AddCategoryRow(table, "To Date  :", dtpToDate.Value.ToShortDateString());

                                this.AddCategoryRow(table, "Report Time :", DateTime.Now.ToString());

                                this.AddTableHeaderRow1(table);
                                ...
                                ReportData chl = new ReportData();

                                var dcc = data[cbxDepartments.Text.ToUpper().ToString()];
                                ...
                                //{
                                        ...
                                        int OtherWorkers = 0;
                                        int Othehours = 0;
                                        foreach (var Date_CadreNics in dcc)
                                        {
                                             chl = new ReportData();
                                             chl.Department = cbxDepartments.Text.ToString();
                                             EffertNoofEmployee = 0;
                                             EffertHours = 0;
                                             OtherWorkers = 0;
                                             Othehours = 0;

                                             chl.Date = Date_CadreNics.Key;
                                            ...
                                            foreach (var CnicHoursEfferts in Date_CadreNics.Value)
                                            {
                                                if (CnicHoursEfferts.Key == "EFFERT")
                                                {
                                                    ...
                                                    chl.EffertHours = EffertHours.ToString();
                                                    chl.EffertNoofEmployee = EffertNoofEmployee.ToString();
                                                ...
                                                else
                                                {
                                                    ...
                                                    chl.Othehours = Othehours.ToString();
                                                    chl.OtherWorkers = OtherWorkers.ToString();
                                        ...
                                        this.AddTableDataRow1(table, chl, i % 2 == 0);
                                        i++;
                                    }
                                ...
                                chl.Date = "Total :";
                                chl.Department = "";
                                chl.EffertHours = NetEffertNoofEmployee.ToString();
                                chl.EffertNoofEmployee = NetEffertHours.ToString();
                                chl.Othehours = NetOtherWorkers.ToString();
                                chl.OtherWorkers = NetOthehours.ToString();

                                this.AddTableDataRow1(table, chl, i % 2 == 0);

                                //if (Manual_EffertNoofEmployee == 0 || Manual_EffertHours == 0 || Manual_OtherWorkers == 0 || Manual_Othehours == 0 )
                                //{
                                i++;
                                chl = new ReportData();
                                chl.Date = "Extra :";
                                chl.Department = "";
                                chl.EffertHours = Manual_EffertNoofEmployee.ToString();
                                chl.EffertNoofEmployee = Manual_EffertHours.ToString();
                                chl.Othehours = Manual_OtherWorkers.ToString();
                                chl.OtherWorkers = Manual_Othehours.ToString();
                                this.AddTableDataRow1(table, chl, i % 2 == 0);
                                //}
                                ...
                                chl.Date = "Net Total :";
                                chl.Department = "";
                                chl.EffertNoofEmployee = (NetEffertNoofEmployee + Manual_EffertNoofEmployee).ToString();
                                chl.EffertHours = (NetEffertHours + Manual_EffertHours).ToString();
                                chl.OtherWorkers = (NetOtherWorkers + Manual_OtherWorkers).ToString();
                                chl.Othehours = (NetOthehours + Manual_Othehours).ToString();
                                this.AddTableDataRow1(table, chl, i % 2 == 0);
        ...
        private void AddTableDataRow(Table table, string Date, string Department, string EFERT_Employees_Entry, string Total_Hours, string Other_Workers_Entry, string Total_Hours_o, bool altRow)
        {
            ...
            table.AddCell(new Cell().
               ...
               SetBorder(new iText.Layout.Borders.SolidBorder(new DeviceRgb(247, 150, 70), 1)).
               SetTextAlignment(int.TryParse(Date,out int res) ? iText.Layout.Properties.TextAlignment.CENTER : iText.Layout.Properties.TextAlignment.LEFT).
               SetVerticalAlignment(iText.Layout.Properties.VerticalAlignment.MIDDLE));
        ...
        private void Man_Hours_Report_Load(object sender, EventArgs e)
        {
        ...
        public void SaveAsPdf1(Dictionary<string, Dictionary<string, Dictionary<string, double>>> data, string heading, SaveFileDialog saveFileDialog1)
        {
            Cursor currentCursor = Cursor.Current;
                ...
                if (data != null)
                {
                    using (PdfWriter pdfWriter = new PdfWriter(saveFileDialog1.FileName))
                    {
                        using (PdfDocument pdfDocument = new PdfDocument(pdfWriter))
                        {
                            ...
                            {
                                doc.SetFont(PdfFontFactory.CreateFont("Fonts/SEGOEUIL.TTF"));
                                string headerLeftText = "Man-Hours Report";
                                string headerRightText = string.Empty;
                                string footerLeftText = "This is computer generated report.";
                                string footerRightText = "Report generated on: " + DateTime.Now.ToString();
                                ...
                                this.AddMainHeading1(table, heading);
        ...
        public void AddMainHeading1(Table table, string heading)
        {
            Cell headingCell = new Cell(2, 4);
            headingCell.SetTextAlignment(iText.Layout.Properties.TextAlignment.CENTER);
            headingCell.SetBorder(new iText.Layout.Borders.SolidBorder(iText.Kernel.Colors.Color.WHITE, 3));
        ...
        public void AddNewEmptyRow1(Table table, bool removeBottomBorder = true)
        {
            table.StartNewRow();
        ...
        public void AddCategoryRow(Table table, string labelName, string Value)
        {
            table.StartNewRow();

           
            table.AddCell(new Cell().
                    Add(new Paragraph(labelName).
                    SetFontSize(11F).
                    SetBold().
        ...
        public void AddTableHeaderRow1(Table table)
        {
            table.StartNewRow();
        ...
        public void AddTableDataRow1(Table table, ReportData chl, bool altRow)
        {
            if (chl == null)
            {
                return;
            ...
            table.AddCell(new Cell().
                    Add(new Paragraph(string.IsNullOrEmpty(chl.Date) ? "0" : chl.Date).
                    SetFontSize(11F)).
                SetBackgroundColor(altRow ? new DeviceRgb(211, 211, 211) : iText.Kernel.Colors.Color.WHITE).
                SetBorder(new iText.Layout.Borders.SolidBorder(new DeviceRgb(247, 150, 70), 1)).
                SetTextAlignment(iText.Layout.Properties.TextAlignment.CENTER).
                SetVerticalAlignment(iText.Layout.Properties.VerticalAlignment.MIDDLE));
            table.AddCell(new Cell().
                    Add(new Paragraph(string.IsNullOrEmpty(chl.Department) ? "0" : chl.Department).
                    SetFontSize(11F)).
                SetBackgroundColor(altRow ? new DeviceRgb(211, 211, 211) : iText.Kernel.Colors.Color.WHITE).
                SetBorder(new iText.Layout.Borders.SolidBorder(new DeviceRgb(247, 150, 70), 1)).
                SetTextAlignment(iText.Layout.Properties.TextAlignment.CENTER).
                SetVerticalAlignment(iText.Layout.Properties.VerticalAlignment.MIDDLE));
            table.AddCell(new Cell().
                    Add(new Paragraph(string.IsNullOrEmpty(chl.EffertNoofEmployee) ? "0" : chl.EffertNoofEmployee).
                    SetFontSize(11F)).
                SetBackgroundColor(altRow ? new DeviceRgb(211, 211, 211) : iText.Kernel.Colors.Color.WHITE).
                SetBorder(new iText.Layout.Borders.SolidBorder(new DeviceRgb(247, 150, 70), 1)).
                SetTextAlignment(iText.Layout.Properties.TextAlignment.CENTER).
                SetVerticalAlignment(iText.Layout.Properties.VerticalAlignment.MIDDLE));
            table.AddCell(new Cell().
                    Add(new Paragraph(string.IsNullOrEmpty(chl.EffertHours) ? "0" : chl.EffertHours).
                    SetFontSize(11F)).
                SetBackgroundColor(altRow ? new DeviceRgb(211, 211, 211) : iText.Kernel.Colors.Color.WHITE).
                SetBorder(new iText.Layout.Borders.SolidBorder(new DeviceRgb(247, 150, 70), 1)).
                SetTextAlignment(iText.Layout.Properties.TextAlignment.CENTER).
                SetVerticalAlignment(iText.Layout.Properties.VerticalAlignment.MIDDLE));
            table.AddCell(new Cell().
                  Add(new Paragraph(string.IsNullOrEmpty(chl.OtherWorkers) ? "0" : chl.OtherWorkers).
                  SetFontSize(11F)).
              SetBackgroundColor(altRow ? new DeviceRgb(211, 211, 211) : iText.Kernel.Colors.Color.WHITE).
              SetBorder(new iText.Layout.Borders.SolidBorder(new DeviceRgb(247, 150, 70), 1)).
              SetTextAlignment(iText.Layout.Properties.TextAlignment.CENTER).
            ...
            table.AddCell(new Cell().
                 Add(new Paragraph(string.IsNullOrEmpty(chl.Othehours) ? "0" : chl.Othehours).
                 SetFontSize(11F)).
             SetBackgroundColor(altRow ? new DeviceRgb(211, 211, 211) : iText.Kernel.Colors.Color.WHITE).
             SetBorder(new iText.Layout.Borders.SolidBorder(new DeviceRgb(247, 150, 70), 1)).
             SetTextAlignment(iText.Layout.Properties.TextAlignment.CENTER).
...

    {
        ...
        public string EffertNoofEmployee { get; set; }
        public string EffertHours{ get; set; }
        public string OtherWorkers{ get; set; }
        public string Othehours{ get; set; }
    }
}
